...
-- Security baseline (Supabase): lock down direct client access.
-- The desktop app writes through the Electron main process using service_role.
...
alter table public.project_revenues force row level security;
...
revoke all on table public.project_revenues from anon, authenticated;
